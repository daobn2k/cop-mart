                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Giá" aria-label="Amount (to the nearest dollar)" name="price">
                                            ...
                                            <div class="input-group mb-3">
  											...
  											<button type="submit" name="newProduct" class="btn btn-primary">Tạo</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
