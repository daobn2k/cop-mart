                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                        	<?php 
  													$product = new Product();
                                                    $result = $product->ProductById($_GET['idEditProduct']);
                                                    $productByID = mysqli_fetch_array($result)
                                            ?>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1"><i class="feather icon-box"></i></span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="Tên sản phẩm" name="name" value="<?php echo $productByID["name"] ?>">
                                            </div>
                                            <select 
                                            style="
                                            	...
                                            	border-bottom-style: solid 2px blue;
                                            " 
                                            ...
                                            name="idSupplier">
  												<?php 
                                                    ...
                                                    $resultSupplier = $supplier->ListSupplier();
                                                    while($nameSupplier = mysqli_fetch_array($resultSupplier)){
  												?>
  												<option value="<?php echo $nameSupplier["id"]?>"><?php echo $nameSupplier["name"]  ?></option>
  												<?php 
  													}
  												?>
											</select>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Giá" aria-label="Amount (to the nearest dollar)" name="price" value="<?php echo $productByID["price"] ?>">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1"><i class="feather icon-power"></i></span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="Số lượng" name="quantity" value="<?php echo $productByID["quantity"] ?>">
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Thông tin</span>
                                                </div>
                                                <textarea name="description" class="form-control" aria-label="With textarea"><?php echo $productByID["description"] ?></textarea>
                                            </div>
