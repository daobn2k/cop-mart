				...
				<div class="pcoded-inner-content">
					<div class="main-body">
						<div class="page-wrapper">
									...
									<div class="row align-items-center">
										<div class="col-md-12">
											...
											<ul class="breadcrumb">
												...
												<li class="breadcrumb-item"><a href="#!">Thêm đơn hàng nhập</a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="row">
                            	<div class="col-md-12">
                            		<button class="btn btn-primary" name="new" type="submit" onclick="location.href = 'NewImportOrder.php?newImportOrder=new';">Tạo mới</button>
                            	</div>
                                <!-- [ Hover-table ] start -->
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Danh sách đơn hàng nhập</h5>
                                        </div>
                                            	...
                                            	?>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a href="">Sửa</a> || <a href="?id=<?php echo $row["id"] ?>" onclick="return confirm('Bạn muốn xóa <?php echo $row["id"] ?> ')">Xóa</a></td>
                                                        </tr>
                                                    </tbody>
                                                <?php 
                                            		}
