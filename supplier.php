                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <?php 
                                                            	if($row["status"]==0){
                                                            ?>
                                                            	<td><a href="?idStatus1=<?php echo $row["id"] ?>">Vô hiệu hóa</a></td>
                                                            <?php 
                                                        		}
                                                        		else if(($row["status"]==1)){
                                                            ?>
                                                            	<td><a href="?idStatus0=<?php echo $row["id"] ?>">Đang hoạt động</a></td>
                                                            <?php 
                                                            	}
                                                            ?>
                                                            <td><a href="EditSupplier.php?idEditSupplier=<?php echo $row["id"] ?>">Sửa</a> || <a href="?id=<?php echo $row["id"] ?>" onclick="return confirm('Bạn muốn xóa <?php echo $row["name"] ?> ')">Xóa</a></td>
                                                        </tr>
                                                    </tbody>
                                                <?php 
                                            		}
