									...
									<div class="row align-items-center">
										<div class="col-md-12">
											...
											<ul class="breadcrumb">
												...
												<li class="breadcrumb-item"><a href="#!">Thêm mới nhà cung cấp</a></li>
											</ul>
										</div>
									</div>
								</div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                        	<?php 
                                        		...
                                        		$result = $supplier->SupplierByID($_GET['idEditSupplier']);
                                        		$supplierByID = mysqli_fetch_array($result)
                                        	?>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1"><i class="feather icon-box"></i></span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="Tên nhà cung cấp" name="name" value="<?php echo $supplierByID["name"] ?>">
                                            </div>
  											<button type="submit" name="updateSupplier" class="btn btn-primary">Sửa</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
